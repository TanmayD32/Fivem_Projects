...
Config = {
    PedCoords = vector4(-8.77, 509.32, 174.63, 356.65), 
    HiddenCoords = vector4(-9.77, 513.89, 174.63, 184.17), 
    CamCoords = vector4(-11.1, 513.89, 174.63, 184.17), 
}
...
AddEventHandler('qb-multicharacter:client:chooseChar', function()
    ...
    DoScreenFadeOut(10)
    Citizen.Wait(1000)
    local interior = GetInteriorAtCoords(-11.1, 513.89, 174.63, 184.17)
...
function skyCam(bool)
    ...
    if bool then
        ...
        cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -7.77, 513.89, 174.63,0.0 ,0.0, 174.5, 60.00, false, 0)
